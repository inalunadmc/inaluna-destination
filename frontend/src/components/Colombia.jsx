...
const destinations = [
  ...
  },
  {
    ...
    titleKey: 'cali_title',
    descKey: 'cali_desc',
    image: 'https://images.unsplash.com/photo-1534943441045-1009d7cb0bb9?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzZ8MHwxfHNlYXJjaHwxfHxjYWxpJTIwY29sb21iaWF8ZW58MHx8fHwxNzgwMDAwNzg0fDA&ixlib=rb-4.1.0&q=85'
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {destinations.map((dest, index) => (
            <motion.div
              ...
              className="group relative h-96 overflow-hidden bg-white shadow-sm transition-all duration-500 hover:shadow-xl"
